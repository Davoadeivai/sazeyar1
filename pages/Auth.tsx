      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-brand-900">
         ...
         <div className="relative z-10 p-16 flex flex-col justify-between h-full text-white">
            <Link to="/" className="flex items-center gap-3 w-fit group">
                ...
                <span className="text-2xl font-bold tracking-tight">سازه‌یار</span>
            </Link>
            ...
            <div className="space-y-6">
                ...
                <p className="text-blue-100 text-lg max-w-md leading-relaxed">
                    به جامعه بزرگ متخصصین و کارفرمایان سازه‌یار بپیوندید. ما کیفیت و اطمینان را در پروژه‌های ساختمانی شما تضمین می‌کنیم.
                </p>
            </div>
        ...
        <div className="w-full max-w-md space-y-8">
            ...
            <div className="lg:hidden text-center mb-8">
                 <Link to="/" className="inline-flex items-center gap-2 mb-6">
                    ...
                    <span className="text-xl font-bold text-gray-900">سازه‌یار</span>
                </Link>
            </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                            <button
                                ...
                                className={`flex flex-col items-center justify-center gap-2 p-3 rounded-xl border-2 transition-all ${
                                    formData.role === UserRole.HOMEOWNER 
                                    ? 'border-brand-500 bg-brand-50 text-brand-700' 
                                    : 'border-gray-100 bg-white text-gray-500 hover:border-gray-200'
                                }`}
                            >
                                <User size={20} />
                                <span className="text-xs font-bold">کارفرما</span>
                            </button>
                            ...
                            >
                                <HardHat size={20} />
                                <span className="text-xs font-bold">متخصص</span>
                            </button>
                            ...
                            >
                                <ShieldCheck size={20} />
                                <span className="text-xs font-bold">ادمین</span>
                            </button>
                        </div>
                    </div>
                )}
