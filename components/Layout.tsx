...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    setSettings(StorageService.getSettings()); // Refresh settings on route change (simulating dynamic update)
  }, [location.pathname]);
          ...
          <div className="flex justify-between items-center">
            ...
            <Link to="/" className="flex items-center gap-2.5 group">
              ...
              <span className={`text-2xl font-black tracking-tighter ${scrolled ? 'text-gray-900' : 'text-gray-900'}`}>
                سازه‌<span className="text-brand-500">یار</span>
              </span>
            </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            ...
            <div className="col-span-1 md:col-span-2 space-y-6">
              <div className="flex items-center gap-3">
                ...
                <span className="text-3xl font-black tracking-tight">سازه‌یار</span>
              </div>
              <p className="text-indigo-200 leading-relaxed max-w-sm text-justify">
                ما باور داریم که ساختن خانه نباید استرس‌زا باشد. با ترکیب تکنولوژی هوش مصنوعی و تخصص انسانی، تجربه‌ای لذت‌بخش و شفاف از بازسازی را برایتان رقم می‌زنیم.
              </p>
